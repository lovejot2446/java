     ...
     <a href="Logout">Logout</a>
        ...
        <header class="main-header">
          ...
          <section class="container content-section">
             <h2 class="section-header">Catering</h2>
            <div class="shop-items">
                <div class="shop-item">
                
                <div class="boxed1">
        <div class="job-title">       
Sweet Palace Catering
</div>

<div class="job-description">
Whether you are planning a wedding, birthday party or corporate event in Brampton, Mississauga or anywhere in the GTA, our experienced and creative team of designers and chefs will provide you with everything you need to produce a flawless event.

Blairs Catering handles every detail so that our clients may feel like guests at their own party.
</div>


<div class="apply">Easily Apply</div>
<div class="contact">
tkscatering@gmail.com
</div>
...
PreparedStatement ps=conn.prepareStatement("select * from job where category_name='Catering'");
