...
<tr>
<td colspan=2>
<center><font size=5><h1><b>LogIn  Form</b></h1></font></center>
</td>
</tr>
...
<tr>
<td><input type="reset"style="background-color:black;color:white;" ></td>
<td colspan="2"><input type="submit" value="Login" style="background-color:black;color:white;"required/></td>
</tr>
</table>
