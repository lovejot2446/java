     ...
     <a href="Logout">Logout</a>
        ...
        <header class="main-header">
          ...
          <section class="container content-section">
             <h2 class="section-header">Cleaners</h2>
...
Professional cleaning services is a great investment for anyone who wants to take back a big chunk of their free time and still reap the benefits of a clean space. When you hire Busy B Maids¿s team of professional cleaners to mind the tidiness of your home and business, you can expect the highest quality cleans.
</div>
...
PreparedStatement ps=conn.prepareStatement("select * from job where category_name='Cleaner'");
